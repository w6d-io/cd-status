...
var (
    scans = make(map[string]func(context.Context, types.NamespacedName, int64, int64, string, string, string, string) error)
    scan  func(context.Context, types.NamespacedName, int64, int64, string, string, string, string) error
